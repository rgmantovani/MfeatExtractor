...
# *** Reminder: nominal or categorical attributes must be numerically coded and treated as continuous
# This restriction is because most of the complexity measures rely on distance functions between 
# attributes.
...
cxReplace = function(name) {
  exe = paste(DIR, "/R/dcol/./dcol -i ", DIR, "/", name, ".arff -o ", DIR, "/", name, 
